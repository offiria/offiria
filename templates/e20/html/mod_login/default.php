...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" >
	...
	<input id="modlgn-username" type="text" name="username" class="offiria_inputbox" value="Username" onfocus="if(this.value=='Username'){this.value=''};" onblur="if(this.value==''){this.value='Username'};" title="Username" />
	
	<input id="modlgn-passwd" type="password" name="password" class="offiria_inputbox" value="ThePassword" onfocus="if(this.value=='ThePassword'){this.value=''};" onblur="if(this.value==''){this.value='ThePassword'};" title="Password" />
