...
<ul class="nav nav-pills filter group-filter">
	...
	<li <?php if($filterStatus == 'overdue') echo 'class="active"'; ?>><a href="<?php echo JRoute::_('index.php?' . http_build_query( array_merge($get, array('status' => 'overdue' )) ) ); ?>"><?php echo JText::_('Overdue'); ?></a></li>
	<li <?php if($filterStatus == 'completed') echo 'class="active"'; ?>><a href="<?php echo JRoute::_('index.php?' . http_build_query( array_merge($get, array('status' => 'completed' )) ) ); ?>"><?php echo JText::_('Completed'); ?></a></li>
