<div class="stream-post-message-share tab-content" id="stream-post-event" style="display:none">
	<div class="stream-post-details">
		<input type="text" autocomplete="off" class="event-title" name="title" placeholder="<?php echo JText::_('COM_STREAM_DEFAULT_LABEL_TYPE_YOUR_EVENT_TITLE');?>" value="" />
		<div class="clear"></div>
	</div>
	...
	<div class="stream-post-details">		
		<div class="stream-post-time location">
			...
			<label>
				<input type="checkbox" class="hide-map" name="hide_map" placeholder="<?php echo JText::_('COM_STREAM_LABEL_HIDE_MAP');?>" value="1" /> <?php echo JText::_('COM_STREAM_LABEL_HIDE_MAP');?>
			</label>
		</div>
		<div class="clear"></div>
