...
<div class="weekly-overview-mini">
	<h3><?php echo JText::_('COM_STREAM_WEEKLY_OVERVIEW_TITLE'); ?>
	<a class="btn pull-right" href="#view-daily"><?php echo JText::_('COM_STREAM_WEEKLY_OVERVIEW_VIEW'); ?></a></h3>
	<ul class="nav">
		<li class="ov-milestone-mini tips" original-title="<?php echo JText::_('COM_STREAM_WEEKLY_OVERVIEW_MILESTONE'); ?>">
			<a href="#view-daily"><span><?php echo $milestoneCount;?></span></a>
		</li>
		<li class="ov-todo-mini tips" original-title="<?php echo JText::_('COM_STREAM_WEEKLY_OVERVIEW_TODO'); ?>">
			<a href="#view-daily"><span><?php echo $todoCount;?></span></a>
		</li>
		<li class="ov-event-mini tips" original-title="<?php echo JText::_('COM_STREAM_WEEKLY_OVERVIEW_EVENT'); ?>">
...
<div class="modal weekly-overview" id="daily-overview" style="display:none;">	
	<h1><?php echo JText::_('COM_STREAM_WEEKLY_OVERVIEW_TITLE'); ?>:</h1>
	<h3>
	...
	<a class="close btn"><?php echo JText::_('COM_STREAM_WEEKLY_OVERVIEW_CLOSE'); ?></h1></a>
</div>