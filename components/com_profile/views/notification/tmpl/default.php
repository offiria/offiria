...
<form class="edit" method="post" name="profile-notification" id="profile-notification" action="<?php echo JRoute::_('index.php?option=com_profile&view=edit&task=notification', false);?>">
...
<tr>
	...
	<td>
		<div class="checkboxThree" style="float: right !important;">
			<input type="checkbox" id="<?php echo $emailNotification;?>" name="<?php echo $emailNotification;?>" value="1" <?php echo ($typeSetting->$emailNotification == '1') ? 'checked' : '';?>/>
			<label for="<?php echo $emailNotification;?>"></label>
		</div>
	</td>
</tr>
<?php 
